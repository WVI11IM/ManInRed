...
public class OnFloorSuspicion : MonoBehaviour
{
    ...
    {
        if (blood) PlayerStats.Instance.ModifySuspicionPerFrame(0.75f * suspicionLevel * PeriodVariation());
        else if (dirtySaw) PlayerStats.Instance.ModifySuspicionPerFrame(2f * suspicionLevel * PeriodVariation());
        else if (suitcasePart) PlayerStats.Instance.ModifySuspicionPerFrame(1f * suspicionLevel * PeriodVariation());
        else if(cleanSaw) PlayerStats.Instance.ModifySuspicionPerFrame(0.5f * suspicionLevel * PeriodVariation());
    }
